...
struct EarDoodle: View {
    ...
    var body: some View {
        ZStack {
            ...
            GestureHintView(zhText: "上下拉动", enText: "Pull", isTriggered: viewModel.progress > 0)
        }
    }
}
...
private enum EarDoodleRenderer {
    static func draw(context: GraphicsContext, size: CGSize,
        ...
        // Boing waves when velocity is high. Completion waves are disabled for this infinite toy.
